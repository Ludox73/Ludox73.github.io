...
Showing that the _$k$-orthospectrum_ of the marimba $(X,\Gamma)$ is determined by the melody of random vectors is one of the key technical results in the paper (Proposition 7.1). We do that by showing that the _$k$-orthospectrum_ can be read out the cumulative distribution function of the set of gaps between notes in a random melody. In the next panel we show this numerically for the $1$-orthospectrum, that is for the orthospectrum of $X\setminus\Gamma$.